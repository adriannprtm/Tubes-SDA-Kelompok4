...
void TampilanMainMenu() {
    ...
    gotoxy(72, 24);
    printf("Arnanda Prasatya (221524034)");
    gotoxy(66, 25);
    printf("Jeihan Ilham Kusumawardhana (221524042)");
    gotoxy(65, 26);
    printf("Muhammad Fahri Yuwan Dwi Putra (221524047)");
    gotoxy(24, 1);
...
void TampilanKalkulator() {
    gotoxy(40, 3);
    printf("\033[1;35m _________________________________________\n");
    gotoxy(40, 4);
    ...
    gotoxy(40, 9);
    printf(
        "| |   \033[0;37m(\033[1;35m   | |   \033[0;37m)\033[1;35m   | |   \033[0;37m%%\033[1;35m   | |   \033[0;37m/\033[1;35m   | |\n");
    gotoxy(40, 10);
    printf("| |_______| |_______| |_______| |_______| |\n");
    gotoxy(40, 11);
    printf("|  _______   _______   _______   _______  |\n");
    gotoxy(40, 12);
    printf(
        "| |   \033[0;37m7\033[1;35m   | |   \033[0;37m8\033[1;35m   | |   \033[0;37m9\033[1;35m   | |   \033[0;37m*\033[1;35m   | |\n");
    gotoxy(40, 13);
    printf("| |_______| |_______| |_______| |_______| |\n");
    gotoxy(40, 14);
    printf("|  _______   _______   _______   _______  |\n");
    gotoxy(40, 15);
    printf(
        "| |   \033[0;37m4\033[1;35m   | |   \033[0;37m5\033[1;35m   | |   \033[0;37m6\033[1;35m   | |   \033[0;37m-\033[1;35m   | |\n");
    gotoxy(40, 16);
    printf("| |_______| |_______| |_______| |_______| |\n");
    gotoxy(40, 17);
    printf("|  _______   _______   _______   _______  |\n");
    gotoxy(40, 18);
    printf("| |   \033[0;37m1\033[1;35m   | |   \033[0;37m2\033[1;35m   | |   \033[0;37m3\033[1;35m   | |       | |\n");
    gotoxy(40, 19);
    printf("| |_______| |_______| |_______| |       | |\n");
    gotoxy(40, 20);
    printf("|  _______   _______   _______  |   \033[0;37m+\033[1;35m   | |\n");
    gotoxy(40, 21);
    printf("| |   \033[0;37m.\033[1;35m   | |   \033[0;37m0\033[1;35m   | |   \033[0;37m=\033[1;35m   | |       | |\n");
    gotoxy(40, 22);
    printf("| |_______| |_______| |_______| |_______| |\n");
    gotoxy(40, 23);
    printf("|_________________________________________|\033[0;37m\n");
    gotoxy(40, 25);
...
AppMenu:
    ...
    if ((pil == 1 || pil == 2 || pil == 3 || pil == 4 || pil == 5)) {
        ...
        switch (pil) {
            ...
            displayexpression:
                ...
                if (isValid(expression)) {
                    ...
                    gotoxy(44, 6);
                    printf("%f", count(binaryTree));
                    gotoxy(59, 26);
                    infixToPostfix(binaryTree);
                    gotoxy(59, 27);
                    infixToPrefix(binaryTree);
                    gotoxy(40, 28);
                    printf("Hasil pembulatan dua angka dibelakang koma : %0.2f", round_double(count(binaryTree), 2));
                } else {
                    gotoxy(38, 2);
                    printf("Ekspresi Matematika Yang Anda Masukkan Salah!!!");
                }
            tryAgain:
                gotoxy(44, 30);
        ...
        printf("Maaf, perintah yang Anda masukkan tidak dapat diproses.");
        gotoxy(24, 20);
        printf("Mohon untuk memilih menu dengan angka yang sesuai dengan opsi yang tersedia.");
        gotoxy(55, 21);
        printf("Terima kasih.");
        pil = 0;
        goto AppMenu;
